...
public class ShareBetavilleMessage extends BetavilleNotification{
	 ...
	 */
	public ShareBetavilleMessage(Session session, String userName, String designName, String shareEmail, String comment) throws MessagingException, IOException{
		super(session);
		...
		// Fill the message
		setContent(createContent(userName, shareEmail, designName, comment), "text/html");
